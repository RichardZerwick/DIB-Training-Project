...
<html class="no-js" lang="en">
  <head>
    ...
    <title><?php echo  DIB::$SITENAME; ?> Two Factor Authenticator</title>
  ...
  <body>
    ...
    <div class="bg"></div>
       <form id="login-form" autocomplete="off" action="/dropins/dibAuthenticate/TwoFactor/authenticate" method="POST">			    
             <div class="loginbox">
      <div class="loginbox__container">
        <div class="loginbox__header">
          ...
          <h2><?php echo TwoFactorService::$currentTitle ?></h2>
        </div>
...
*/
          ...
          <div class="field">
            ...
            <label for="password"><?php echo TwoFactorService::$inputLabel;?></label>
          ...
          <a class="forgot" href="/dropins/dibAuthenticate/TwoFactor/reset"><?php echo TwoFactorService::$forgotLinkText;?></a>
        </div>
      </div>
      </form>
