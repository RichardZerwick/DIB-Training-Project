...
class sql_dibexGridSql_x1x {
    ...
    public $sqlFields = array(
			...
			'client_contact_id'=>array("mc.id", 'other', "client_contact_id"),
...
LEFT JOIN test_project p ON p.client_id = c.id  
    ...
    public function getCaptions() {
    	return array("Client", "Company", "Start Date", "VIP", "Email", "Client Contact", "Count Of Projects", "Project Last Updated" );
    }
    public function getSqlParts() {
		return array('model' => 'Sql',
				     'containerName' => "Sqlxx1xxdibexGridSql",
