<?php
class sql_dibexCustomComponentInGrid_x1x {
    public $page = 1;
	public $page_size = 50;
...
LEFT JOIN test_project p ON p.client_id = c.id  
    ...
    public function getCaptions() {
    	return array("Client", "Company", "VIP", "Email", "Count Of Projects", "Project Last Updated" );
    }
    public function getSqlParts() {
		return array('model' => 'Sql',
				     'containerName' => "Sqlxx1xxdibexCustomComponentInGrid",
