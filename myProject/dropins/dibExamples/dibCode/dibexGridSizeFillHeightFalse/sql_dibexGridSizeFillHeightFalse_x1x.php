<?php
class sql_dibexGridSizeFillHeightFalse_x1x {
    public $page = 1;
	public $page_size = 50;
...
LEFT JOIN test_project p ON p.client_id = c.id  
    ...
    public function getCaptions() {
    	return array("Client", "Name", "Start Date", "Email", "Client Contact", "Count Of Projects", "Project Last Updated", "VIP" );
    }
    public function getSqlParts() {
		return array('model' => 'Sql',
				     'containerName' => "Sqlxx1xxdibexGridSizeFillHeightFalse",
