...
class LTable_test_client_66_x1x {
	...
	*/
    public function getList($containerItemId, $page=1, $page_size=0, $query=null, $activeFilter=null, $filterParams=null, $phpFilter='', $phpFilterParams=array(), $pageNoFromValue=null, $showUsedOnly = false) {
        try {
            ...
            if($showUsedOnly) { 
            	$itemTables = array(4378=>"`test_client_contact`.`client_id`", 4461=>"`test_client_contact`.`client_id`", 4724=>"`test_client_contact`.`client_id`", 5789=>"`test_client_contact`.`client_id`", 5792=>"`test_client_contact`.`client_id`", 6088=>"`test_client_contact`.`client_id`", 6108=>"`test_client_contact`.`client_id`", 6167=>"`test_client_contact`.`client_id`", 6187=>"`test_client_contact`.`client_id`", 6207=>"`test_client_contact`.`client_id`", 6840=>"`test_client_contact`.`client_id`", 4186=>"`test_project`.`client_id`", 4193=>"`test_project`.`client_id`", 5920=>"`test_project`.`client_id`");
