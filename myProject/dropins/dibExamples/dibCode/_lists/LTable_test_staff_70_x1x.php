<?php
class LTable_test_staff_70_x1x {
	...
	*/
    public function getList($containerItemId, $page=1, $page_size=0, $query=null, $activeFilter=null, $filterParams=null, $phpFilter='', $phpFilterParams=array(), $pageNoFromValue=null, $showUsedOnly = false) {
        try {
            ...
            if($showUsedOnly) { 
            	$itemTables = array(4187=>"`test_project`.`project_leader_id`", 4194=>"`test_project`.`project_leader_id`", 5921=>"`test_project`.`project_leader_id`", 5182=>"`test_staff`.`manager_id`", 5407=>"`test_staff`.`manager_id`", 4211=>"`test_staff_project`.`staff_id`", 7192=>"`test_staff_project`.`staff_id`");
