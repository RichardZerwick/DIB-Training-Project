<?php
class sql_dibexSqlParamsPhp_x1x {
    public $page = 1;
	public $page_size = 50;
    ...
    public $sqlFields = array(
			...
			'main_branch'=>array("__mainBranch__", 'other', "main_branch"),
...
{:/dropins/dibExamples/SqlPhpParams/replaceParams})";
...
INNER JOIN test_client_contact mc ON mc.client_id = c.id 
            ...
            $sqlTotal = SqlTools::resolvePhpParam('dibexSqlParamsPhp', $sqlTotal, $params, $filterParams);
...
INNER JOIN test_client_contact mc ON mc.client_id = c.id 
		        ...
		        $havingCrit 
		        $orderStr $limit"; 
            $sql = SqlTools::resolvePhpParam('dibexSqlParamsPhp', $sql, $params, $filterParams);
            if(is_array($sql))
                return $sql;
    ...
    public function getCaptions() {
    	return array("Client", "Main Branch", "Client Contact", "Email", "Position" );
    }
    public function getSqlParts() {
		return array('model' => 'Sql',
				     'containerName' => "Sqlxx1xxdibexSqlParamsPhp",
					 'primary_field' => "cc_id",
                     'display_field' => "",                     
