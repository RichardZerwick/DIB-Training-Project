...
$params = array('action'=>'btnPrompt', 'actionType'=>'itemAlias', 'trigger'=>'click', 'containerName'=>$containerName, 'portId'=>null);
ClientFunctions::addAction($actionList, 'run', $params);

$params = array('action'=>'btnPopup', 'actionType'=>'itemAlias', 'trigger'=>'click', 'containerName'=>$containerName, 'portId'=>null);
ClientFunctions::addAction($actionList, 'run', $params);
