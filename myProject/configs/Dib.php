...
class DIB {
    ...
    */
    ...
    const LOGINDBINDEX=5; // Database containing the pef_login, pef_perm_group and pef_security_policy tables	
	...
	public static $WRITE_ERRORS_TO = 'file'; // Write errors to file/db/file&db. Note if Dropinbase cannot write to the database, it will always attempt to write to the file (/runtime/logs/error.log).
	...
	public static $BASEURL='https://localhost';
	public static $BASEPATH='/dropinbase/';
    public static $DROPINPATHDEV='/dropinbase/dropins/';
    public static $RUNTIMEPATH='/dropinbase/runtime/';
    public static $FILESPATH='/dropinbase/files/';
	public static $SYSTEMPATH='/vendor/dropinbase/dropinbase/';
    public static $EXTPATH= '/vendor/dropinbase/dropinbase/extensions/';
